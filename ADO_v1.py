...
class MyApp(QWidget):
    def __init__(self):
        super().__init__()
        self.title = 'ASIAIR DATA ORGANIZER'
        self.left = 100
        self.top = 100
        self.width = 290
        self.height = 225
    ...
    def initUI(self):
        ...
        self.select_folder_button.setStyleSheet("background-color: #666666; color: white; font: bold;")
        self.select_folder_button.setCursor(Qt.PointingHandCursor)
        self.select_folder_button.enterEvent = lambda event: self.select_folder_button.setStyleSheet("background-color: #333333; color: white; font: bold;")
        self.select_folder_button.leaveEvent = lambda event: self.select_folder_button.setStyleSheet("background-color: #666666; color: white; font: bold;")
        self.select_folder_button.mousePressEvent = lambda event: self.select_folder_button.setStyleSheet("background-color: #000000; color: white; font: bold;")
        self.select_folder_button.mouseReleaseEvent = lambda event: self.select_folder_button.setStyleSheet("background-color: #333333; color: white; font: bold;")

        # Create a "Organize" button
        self.organize_button = QPushButton("Organize By...", self)
        self.organize_button.clicked.connect(self.organize)
        self.organize_button.setStyleSheet("background-color: #666666; color: white; font: bold;")
        self.organize_button.setCursor(Qt.PointingHandCursor)
        self.organize_button.enterEvent = lambda event: self.organize_button.setStyleSheet("background-color: #333333; color: white; font: bold;")
        self.organize_button.leaveEvent = lambda event: self.organize_button.setStyleSheet("background-color: #666666; color: white; font: bold;")
        self.organize_button.mousePressEvent = lambda event: self.organize_button.setStyleSheet("background-color: #000000; color: white; font: bold;")
        self.organize_button.mouseReleaseEvent = lambda event: self.organize_button.setStyleSheet("background-color: #333333; color: white; font: bold;")

        # Create checkboxes for organizing by filter, target, and exposure time
        self.by_filter_checkbox = QCheckBox("Filter", self)
        self.by_filter_checkbox.setStyleSheet("color: white; font-weight: bold;") 
        self.by_target_checkbox = QCheckBox("Target", self)
        self.by_target_checkbox.setStyleSheet("color: white; font-weight: bold;")
        self.by_exposure_time_checkbox = QCheckBox("Exposure Time", self)
        self.by_exposure_time_checkbox.setStyleSheet("color: white; font-weight: bold;")
